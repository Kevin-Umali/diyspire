...
import { generateProjectExplanations, getShareLinkData, saveShareLinkData, searchImages } from "../api/open-ai-api";
...
const ProjectDetail: React.FC = () => {
  ...
  const [project, setProject] = useState<ProjectLocationState | null>(location?.state?.project);
