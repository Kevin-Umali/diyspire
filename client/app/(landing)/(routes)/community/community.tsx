...
import ProjectCard from "@/landing/components/diy-card";

export default function CommunityGeneratedIdeaList() {
  const [currentPage, setCurrentPage] = useState(1);
  const limitPerPage = 10;

  const { data: communityData, error, isLoading, isSuccess } = useCommunityGeneratedIdea({ page: currentPage, limit: limitPerPage, sortBy: "desc" });
  ...
  return (
    <div className="container mx-auto px-5 py-12 sm:px-10">
      <div className="mb-12 text-center">
        <h1 className="mb-3 text-3xl font-semibold lg:text-4xl">&ldquo;DIYspire&rdquo; Community Generated Idea</h1>
