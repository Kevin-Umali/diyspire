...
import BudgetFilter from "@/components/generate/budget-filter";
...
import GenerateLoading from "@/components/generate/generate-loading";
import MaterialInput from "@/components/generate/material-input";
import ProjectTabs from "@/components/generate/project-tabs";
import SafetyCheck from "@/components/generate/safety-check";
import TimeAvailabilityFilter from "@/components/generate/time-availability-filter";
import ToolsAvailableInput from "@/components/generate/tools-available-input";
import { categories } from "@/constants";
import { Button } from "@/components/ui/button";
import PurposeFilter from "@/components/generate/purpose-filter";
    ...
    if (isGenerated) {
      return (
        <div className="mb-4">
          ...
          <Button className="mt-4 px-4 py-2" onClick={() => setIsGenerated(false)}>
    ...
    return (
      <>
        ...
        <div className="flex justify-between items-center mb-4">
          ...
          <Button className="px-4 py-2 mt-4 w-full lg:w-auto focus:outline-none focus:ring-20 focus:ring-opacity-50 flex items-center justify-center space-x-2" onClick={handleGenerateProjects}>
            <RefreshCcw className="w-5 h-5" />
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="mb-4 px-4 py-2 rounded-md">
        <Label className="text-center font-bold text-md lg:text-lg">
          🎉
